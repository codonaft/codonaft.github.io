...
В последнее время я в основном причесывал верстку на сайте, допиливал-интегрировал [систему комментирования]({{ site.theme_settings.nostr.git_client }}/{{ site.theme_settings.nostr.npub }}/zapthreads-codonaft#readme) и плеер.
