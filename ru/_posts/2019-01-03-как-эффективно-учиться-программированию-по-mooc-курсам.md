...
- videospeed
    - [Chromium](https://chromewebstore.google.com/detail/video-speed-controller/nffaoalbilbmmfgbnbgppjihopabppdk) ([GitHub]({{ site.theme_settings.foss_frontends.github }}/igrigorik/videospeed#readme))
    - [Firefox](https://addons.mozilla.org/en-US/firefox/addon/videospeed/) ([GitHub]({{ site.theme_settings.foss_frontends.github }}/codebicycle/videospeed#readme))
- [Video Speed Controller]({{ site.theme_settings.foss_frontends.github }}/younglee327/video-speed-controller#readme)

Подборки курсов:
- [Open Source Society University]({{ site.theme_settings.foss_frontends.github }}/ossu/computer-science#open-source-society-university)
- [Computer Science courses with video lectures]({{ site.theme_settings.foss_frontends.github }}/Developer-Y/cs-video-courses#computer-science-courses-with-video-lectures)
...
- [Академия Яндекса ➜ Для школьников ➜ Малый ШАД]({{ site.theme_settings.foss_frontends.youtube }}/channel/UCJ52ijV5RyPNSijdrEe73VQ/playlists?sort=dd&shelf_id=1&view=50)
- [Базовые алгоритмы для школьников]({{ site.theme_settings.foss_frontends.youtube }}/playlist?list=PLDrmKwRSNx7KcHxyf9hSmF3fTLKSwujkM)
- [Видеозаписи лекций ЛКШ](https://sis.khashaev.ru/)
...
и [такого]({{ site.theme_settings.foss_frontends.youtube }}/watch?v=nxWfZP6eslM).
...
[«Википедию»]({{ site.theme_settings.foss_frontends.wikipedia_en }}/wiki/Personal_knowledge_management#Tools),
