...
Потом, когда я открыл для себя [MOOC]({{ site.theme_settings.foss_frontends.wikipedia_en }}/wiki/Massive_open_online_course) видео курсы, продолжил использовать те же антипаттерны, что и в школьные времена, но уже не так безобразно: с помощью [VimWiki](https://vimwiki.github.io) и позже — с [Jupyter](https://jupyter.org).
