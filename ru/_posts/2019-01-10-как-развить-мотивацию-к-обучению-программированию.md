...
Кстати, для [метода помидора]({{ site.theme_settings.foss_frontends.wikipedia_ru }}/wiki/Метод_помидора)
...
- [Extrinsic vs Intrinsic Motivation]({{ site.theme_settings.foss_frontends.youtube }}/results?search_query=extrinsic+vs+intrinsic+motivation)
- [Positive vs Negative Motivation]({{ site.theme_settings.foss_frontends.youtube }}/results?search_query=positive+vs+negative+motivation)
- [How to Motivate Yourself]({{ site.theme_settings.foss_frontends.youtube }}/results?search_query=how+to+motivate+yourself)
