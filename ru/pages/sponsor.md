    ...
    <ul>
      <li>нажать ⭐ на страницах понравившихся <a href="https://github.com/alopatindev">проектов</a>
        <ul>
          ...
          <li>помочь конкретно проекту <a href="https://github.com/cargo-limit/cargo-limit#support"><img style="display: inline-block; vertical-align: middle; width: 1.4rem; height: 1.4rem" src="/assets/img/cargo-limit.svg">cargo-limit</a></li>
        </ul>
      </li>
      <li class="padding-top-small">общими донатами на {% include span_with_tooltip.html body="всё" tooltip="Разработку свободного ПО и связанного с этим видео/текстового контента" %} что я произвожу:</li>
    </ul>
  </div>
</div>
...
Необязательно «не так», они там куда им удалось дорасти.
Обычно они
{% include span_with_tooltip.html body="не могут или не хотят" tooltip="Да, даже огромные компании, которые уже производят некоторый <span class='no-wrap'>Open Source!</span>" %}
создавать продукты достаточно этичным образом.
...
Из-за *возможности* обойтись без всего этого варварства {% include span_with_tooltip.html body="с самого начала" tooltip="В обмен на риск своей собственной устойчивости" %}.
</details>
Сама по себе эта {% include span_with_tooltip.html large="true" body="возможность" tooltip="Выражать ценности такого плана <span class='no-wrap'>с самого начала</span>" %} настолько ценна для меня, что я больше не нахожу традиционные коммерческие организации привлекательными для себя.
