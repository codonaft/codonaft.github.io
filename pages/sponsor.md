    ...
    <ul>
      <li>press ⭐ in the <a href="https://github.com/alopatindev">repos you like</a>
        <ul>
          ...
          <li>help specifically <a href="https://github.com/cargo-limit/cargo-limit#support"><img style="display: inline-block; vertical-align: middle; width: 1.4rem; height: 1.4rem" src="/assets/img/cargo-limit.svg">cargo-limit</a> project</li>
        </ul>
      </li>
      <li class="padding-top-small">make general donations for {% include span_with_tooltip.html body="everything" tooltip="FOSS development <span class='no-wrap'>and related Blogging / Vlogging</span>" %} I produce:</li>
    </ul>
  </div>
</div>
...
Not necessarily "wrong"; they are wherever they managed to grow.
Usually they
{% include span_with_tooltip.html body="can't or aren't willing" tooltip="Yes, even huge companies that already produce some Open Source!" %}
to make products ethical enough way.
...
- Pros:
    ...
    - 👍 full decisions control
        ...
        - innovations {% include span_with_tooltip.html large="true" body="freedom" tooltip="<i>Technically</i>, you can introduce any adequate innovations (including simple things, like one-time authentication link sent via email), while typical commercial organization would usually decline certain useful innovations and prefer disastrous dominant technologies for various &quot;rational&quot; reasons. Or might even integrate irrelevant popular technologies in order to &quot;sell better&quot; 🤦‍♂️" %}
- Cons:
...
Due to <i>possibility</i> to start without all this barbarism {% include span_with_tooltip.html large="true" body="from the very beginning" tooltip="Increasing risk of my own sustainability as a tradeoff" %}.
</details>
The {% include span_with_tooltip.html large="true" body="possibility" tooltip="To express these kind of values <span class='no-wrap'>from the very beginning</span>" %} itself is so valuable to me that I no longer find traditional businesses attractive to me.
